...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if(!glview) {
        ...
        glview = GLViewImpl::createWithRect("01_HelloWorld", cocos2d::Rect(0, 0, designResolutionSize.width, designResolutionSize.height));
#else
        glview = GLViewImpl::create("01_HelloWorld");
#endif
	...
	TransitionRotoZoom* animation = TransitionRotoZoom::create(1, scene);

    // run
    director->runWithScene(animation);
